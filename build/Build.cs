...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-graphql-codegen";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need graphql-codegen on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.GraphQLCodegen.V5.Tests" / "Tamp.GraphQLCodegen.V5.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.GraphQLCodegen.V5" / "Tamp.GraphQLCodegen.V5.csproj");
